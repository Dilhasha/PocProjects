...
public isolated function getTimestampInMillis2() returns int {
...
public isolated function getUpdatedGrpcHeaders2(map<string|string[]> headers, int hopIncrement = 0) returns map<string|string[]> {
