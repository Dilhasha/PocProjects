...
function decodePrivateKey45() returns crypto:PrivateKey|error {
...
function decodePublicKey45() returns crypto:PublicKey|error {
...
function encrypt45() returns error? {
...
public function testrandom() returns error? {
    check hash();
    check hmac();
    check sign();
    check encrypt();
