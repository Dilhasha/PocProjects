...
public function newEmail3dd() returns error?{
...
public function newEmail() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmailold2() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmailold1() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmailold() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
