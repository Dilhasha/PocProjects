...
public function newEmail2() returns error?{
...
public function newEmail2new3() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmail2new2() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmail1() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmail2latestnew() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
...
public function newEmail2new() returns error?{
    // Creates an SMTP client with the connection parameters, host, username,
    // and password. Default port number `465` is used over SSL with these
    // configurations.
    email:SmtpClient smtpClient = check new ("smtp.email.com", "sender@email.com"
